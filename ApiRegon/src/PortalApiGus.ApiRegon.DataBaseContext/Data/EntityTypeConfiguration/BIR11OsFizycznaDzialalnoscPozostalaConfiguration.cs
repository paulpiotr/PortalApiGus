...
{
    public class BIR11OsFizycznaDzialalnoscPozostalaConfiguration : IEntityTypeConfiguration<
        BIR11OsFizycznaDzialalnoscPozostala>
    {
        public void Configure(EntityTypeBuilder<BIR11OsFizycznaDzialalnoscPozostala> builder)
        {
