...
{
    public class BIR11OsPrawnaSpCywilnaWspolnicyConfiguration : IEntityTypeConfiguration<
        BIR11OsPrawnaSpCywilnaWspolnicy>
    {
        public void Configure(EntityTypeBuilder<BIR11OsPrawnaSpCywilnaWspolnicy> builder)
        {
