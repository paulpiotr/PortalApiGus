...
{
    public class BIR11OsFizycznaDzialalnoscRolniczaConfiguration : IEntityTypeConfiguration<
        BIR11OsFizycznaDzialalnoscRolnicza>
    {
        public void Configure(EntityTypeBuilder<BIR11OsFizycznaDzialalnoscRolnicza> builder)
        {
