...
{
    public class BIR11JednLokalnaOsPrawnejPkdConfiguration : IEntityTypeConfiguration<
        BIR11JednLokalnaOsPrawnejPkd>
    {
        public void Configure(EntityTypeBuilder<BIR11JednLokalnaOsPrawnejPkd> builder)
        {
