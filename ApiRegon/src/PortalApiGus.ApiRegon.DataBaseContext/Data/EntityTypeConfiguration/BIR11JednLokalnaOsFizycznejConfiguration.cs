...
{
    public class BIR11JednLokalnaOsFizycznejConfiguration : IEntityTypeConfiguration<
        BIR11JednLokalnaOsFizycznej>
    {
        public void Configure(EntityTypeBuilder<BIR11JednLokalnaOsFizycznej> builder)
        {
