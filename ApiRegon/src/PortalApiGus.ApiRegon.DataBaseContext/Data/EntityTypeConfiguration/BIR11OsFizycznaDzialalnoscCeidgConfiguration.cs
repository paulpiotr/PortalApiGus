...
{
    public class BIR11OsFizycznaDzialalnoscCeidgConfiguration : IEntityTypeConfiguration<
        BIR11OsFizycznaDzialalnoscCeidg>
    {
        public void Configure(EntityTypeBuilder<BIR11OsFizycznaDzialalnoscCeidg> builder)
        {
