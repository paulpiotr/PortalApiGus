...
{
    public class DanePobierzPelnyRaportRepository : DaneSzukajPodmiotyRepository, IDanePobierzPelnyRaportRepository
    {
        ...
        #region public DanePobierzPelnyRaportRepository...

        public DanePobierzPelnyRaportRepository()
        {
        ...
        public DanePobierzPelnyRaportRepository(DataBaseContext context)
        {
            _context = context;
        }
        ...
        public DanePobierzPelnyRaportRepository(IServiceProvider serviceProvider)
        {
            try
            {
        ...
        public DanePobierzPelnyRaportRepository(IServiceScopeFactory serviceScopeFactory)
        {
            try
            {
        ...
        public new async Task<DaneSzukajPodmiotyResult>? FindByKrsAsync(string krs, int cacheLifeTime = 0) =>
        ...
        public new DaneSzukajPodmiotyResult? FindByKrs(string krs, int cacheLifeTime = 0) =>
        ...
        public new async Task<DaneSzukajPodmiotyResult>? FindByKrsyAsync(string krsy, int cacheLifeTime = 0) =>
        ...
        public new DaneSzukajPodmiotyResult? FindByKrsy(string krsy, int cacheLifeTime = 0) =>
        ...
        public new async Task<DaneSzukajPodmiotyResult>? FindByNipAsync(string nip, int cacheLifeTime = 0) =>
        ...
        public new DaneSzukajPodmiotyResult? FindByNip(string nip, int cacheLifeTime = 0) =>
