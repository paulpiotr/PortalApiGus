...
{
    #region public class BIR11NowePodmiotyPrawneOrazDzialalnosciOsFizycznych : BaseEntity
    ...
    /// </summary>
    [Table(nameof(BIR11NowePodmiotyPrawneOrazDzialalnosciOsFizycznych), Schema = "pagard")]
    [JsonObject(nameof(BIR11NowePodmiotyPrawneOrazDzialalnosciOsFizycznych))]
    [Display(Name = "BIR11NowePodmiotyPrawneOrazDzialalnosciOsFizycznych",
        Description = "BIR11NowePodmiotyPrawneOrazDzialalnosciOsFizycznych")]
    [Serializable]
    [XmlRoot("dane")]
    [Index(nameof(Regon))]
    public class BIR11NowePodmiotyPrawneOrazDzialalnosciOsFizycznych : BaseEntity
    {
