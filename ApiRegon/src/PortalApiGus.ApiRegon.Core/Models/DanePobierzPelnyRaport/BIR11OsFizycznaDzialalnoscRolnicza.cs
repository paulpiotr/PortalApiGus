...
{
    #region public class BIR11OsFizycznaDzialalnoscRolnicza : DanePobierzPelnyRaport

    /// <summary>
    ///     Model danych PortalApiGus.ApiRegon.Core.Models.DanePobierzPelnyRaport BIR11OsFizycznaDzialalnoscRolnicza
    ///     Data model of entities found in the basic report
    /// </summary>
    [Table(nameof(BIR11OsFizycznaDzialalnoscRolnicza), Schema = "pagard")]
    [JsonObject(nameof(BIR11OsFizycznaDzialalnoscRolnicza))]
    [Display(Name = "BIR11OsFizycznaDzialalnoscRolnicza", Description = "BIR11OsFizycznaDzialalnoscRolnicza")]
    [Serializable]
    [XmlRoot("dane")]
    ...
    [Index(nameof(FizDataSkresleniaDzialalanosciZRegon))]
    ...
    public class BIR11OsFizycznaDzialalnoscRolnicza : DanePobierzPelnyRaport
    {
        ...
        {
            BIR11OsFizycznaDzialalnoscRolnicza model =
                XmlHelper.DeserializeXmlFromString<BIR11OsFizycznaDzialalnoscRolnicza>(xml) ??
                new BIR11OsFizycznaDzialalnoscRolnicza();
            model.PRegon = pRegon;
            ...
            {
                model.BIR11OsFizycznaDzialalnoscRolniczaMessageInspector =
                    new List<BIR11OsFizycznaDzialalnoscRolniczaMessageInspector>();
                foreach (MessageInspector messageInspector in messageInspectorCollection)
                {
                    model.BIR11OsFizycznaDzialalnoscRolniczaMessageInspector.Add(
                        new BIR11OsFizycznaDzialalnoscRolniczaMessageInspector(
        ...
        [InverseProperty("BIR11OsFizycznaDzialalnoscRolnicza")]
        ...
        private ICollection<BIR11OsFizycznaDzialalnoscRolniczaMessageInspector> _modelMessageInspector;
        ...
        #region private string? _fizDataSkresleniaDzialalanosciZRegon; public string? FizDataSkresleniaDzialalanosciZRegon

        private string? _fizDataSkresleniaDzialalanosciZRegon;

        /// Fiz data skreslenia dzialalanosci z regon
        /// Fiz data skreslenia dzialalanosci z regon
        [Column(Order = 2)]
        [XmlElement("fiz_dataSkresleniaDzialalanosciZRegon")]
        [JsonProperty(nameof(FizDataSkresleniaDzialalanosciZRegon), Order = 2)]
        [Display(Name = "Fiz data skreslenia dzialalanosci z regon",
            Prompt = "Wpisz Fiz data skreslenia dzialalanosci z regon",
            Description = "Fiz data skreslenia dzialalanosci z regon")]
        [StringLength(10)]
        [MaxLength(10)]

        public string? FizDataSkresleniaDzialalanosciZRegon
        {
            get => _fizDataSkresleniaDzialalanosciZRegon;
            set
            {
                if (value != _fizDataSkresleniaDzialalanosciZRegon)
                {
                    _fizDataSkresleniaDzialalanosciZRegon = value;
                    OnPropertyChanged(nameof(FizDataSkresleniaDzialalanosciZRegon));
                }
            }
        }
