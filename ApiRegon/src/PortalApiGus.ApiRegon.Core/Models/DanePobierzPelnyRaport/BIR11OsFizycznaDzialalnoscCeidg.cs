...
{
    #region public class BIR11OsFizycznaDzialalnoscCeidg : BaseEntity

    /// <summary>
    ///     Model danych PortalApiGus.ApiRegon.Core.Models.DanePobierzPelnyRaport BIR11OsFizycznaDzialalnoscCeidg
    ///     Data model of entities found in the basic report
    /// </summary>
    [Table(nameof(BIR11OsFizycznaDzialalnoscCeidg), Schema = "pagard")]
    [JsonObject(nameof(BIR11OsFizycznaDzialalnoscCeidg))]
    [Display(Name = "BIR11OsFizycznaDzialalnoscCeidg", Description = "BIR11OsFizycznaDzialalnoscCeidg")]
    [Serializable]
    [XmlRoot("dane")]
    ...
    [Index(nameof(FizCDataWpisuDoRejestruEwidencji))]
    [Index(nameof(FizCDataSkresleniaZRejestruEwidencji))]
    [Index(nameof(FizCNumerWRejestrzeEwidencji))]
    [Index(nameof(FizCOrganRejestrowySymbol))]
    [Index(nameof(FizCOrganRejestrowyNazwa))]
    [Index(nameof(FizCRodzajRejestruSymbol))]
    [Index(nameof(FizCRodzajRejestruNazwa))]
    [Index(nameof(FizCNiePodjetoDzialalnosci))]
    public class BIR11OsFizycznaDzialalnoscCeidg : DanePobierzPelnyRaport
    {
        ...
        {
            BIR11OsFizycznaDzialalnoscCeidg model =
                XmlHelper.DeserializeXmlFromString<BIR11OsFizycznaDzialalnoscCeidg>(xml) ??
                new BIR11OsFizycznaDzialalnoscCeidg();
            model.PRegon = pRegon;
            ...
            {
                model.BIR11OsFizycznaDzialalnoscCeidgMessageInspector =
                    new List<BIR11OsFizycznaDzialalnoscCeidgMessageInspector>();
                foreach(MessageInspector messageInspector in messageInspectorCollection)
                {
                    model.BIR11OsFizycznaDzialalnoscCeidgMessageInspector.Add(
                        new BIR11OsFizycznaDzialalnoscCeidgMessageInspector(
        ...
        [InverseProperty("BIR11OsFizycznaDzialalnoscCeidg")]
        ...
        private ICollection<BIR11OsFizycznaDzialalnoscCeidgMessageInspector> _modelMessageInspector;
        ...
        #region private string? _fizcDataWpisuDoRejestruEwidencji; public string? FizCDataWpisuDoRejestruEwidencji

        private string? _fizcDataWpisuDoRejestruEwidencji;

        /// Fiz c data wpisu do rejestru ewidencji
        /// Fiz c data wpisu do rejestru ewidencji
        [Column(Order = 2)]
        [XmlElement("fizC_dataWpisuDoRejestruEwidencji")]
        [JsonProperty(nameof(FizCDataWpisuDoRejestruEwidencji), Order = 2)]
        [Display(Name = "Fiz c data wpisu do rejestru ewidencji",
            Prompt = "Wpisz Fiz c data wpisu do rejestru ewidencji",
            Description = "Fiz c data wpisu do rejestru ewidencji")]
        [StringLength(10)]
        [MaxLength(10)]

        public string? FizCDataWpisuDoRejestruEwidencji
        {
            get => _fizcDataWpisuDoRejestruEwidencji;
            set
            {
                if (value != _fizcDataWpisuDoRejestruEwidencji)
                {
                    _fizcDataWpisuDoRejestruEwidencji = value;
                    OnPropertyChanged(nameof(FizCDataWpisuDoRejestruEwidencji));
                }
            }
        }
        ...
        #region private string? _fizcDataSkresleniaZRejestruEwidencji; public string? FizCDataSkresleniaZRejestruEwidencji

        private string? _fizcDataSkresleniaZRejestruEwidencji;

        /// Fiz c data skreslenia z rejestru ewidencji
        /// Fiz c data skreslenia z rejestru ewidencji
        [Column(Order = 2)]
        [XmlElement("fizC_dataSkresleniaZRejestruEwidencji")]
        [JsonProperty(nameof(FizCDataSkresleniaZRejestruEwidencji), Order = 2)]
        [Display(Name = "Fiz c data skreslenia z rejestru ewidencji",
            Prompt = "Wpisz Fiz c data skreslenia z rejestru ewidencji",
            Description = "Fiz c data skreslenia z rejestru ewidencji")]
        [StringLength(10)]
        [MaxLength(10)]

        public string? FizCDataSkresleniaZRejestruEwidencji
        {
            get => _fizcDataSkresleniaZRejestruEwidencji;
            set
            {
                if (value != _fizcDataSkresleniaZRejestruEwidencji)
                {
                    _fizcDataSkresleniaZRejestruEwidencji = value;
                    OnPropertyChanged(nameof(FizCDataSkresleniaZRejestruEwidencji));
                }
            }
        }
        ...
        #region private string? _fizcNumerWRejestrzeEwidencji; public string? FizCNumerWRejestrzeEwidencji

        private string? _fizcNumerWRejestrzeEwidencji;

        /// Fiz c numer w rejestrze ewidencji
        /// Fiz c numer w rejestrze ewidencji
        [Column(Order = 2)]
        [XmlElement("fizC_numerWRejestrzeEwidencji")]
        [JsonProperty(nameof(FizCNumerWRejestrzeEwidencji), Order = 2)]
        [Display(Name = "Fiz c numer w rejestrze ewidencji", Prompt = "Wpisz Fiz c numer w rejestrze ewidencji",
            Description = "Fiz c numer w rejestrze ewidencji")]
        [StringLength(50)]
        [MaxLength(50)]

        public string? FizCNumerWRejestrzeEwidencji
        {
            get => _fizcNumerWRejestrzeEwidencji;
            set
            {
                if (value != _fizcNumerWRejestrzeEwidencji)
                {
                    _fizcNumerWRejestrzeEwidencji = value;
                    OnPropertyChanged(nameof(FizCNumerWRejestrzeEwidencji));
                }
            }
        }
        ...
        #region private string? _fizcOrganRejestrowySymbol; public string? FizCOrganRejestrowySymbol

        private string? _fizcOrganRejestrowySymbol;

        /// Fiz c organ rejestrowy symbol
        /// Fiz c organ rejestrowy symbol
        [Column(Order = 2)]
        [XmlElement("fizC_OrganRejestrowy_Symbol")]
        [JsonProperty(nameof(FizCOrganRejestrowySymbol), Order = 2)]
        [Display(Name = "Fiz c organ rejestrowy symbol", Prompt = "Wpisz Fiz c organ rejestrowy symbol",
            Description = "Fiz c organ rejestrowy symbol")]
        [StringLength(9)]
        [MaxLength(9)]

        public string? FizCOrganRejestrowySymbol
        {
            get => _fizcOrganRejestrowySymbol;
            set
            {
                if (value != _fizcOrganRejestrowySymbol)
                {
                    _fizcOrganRejestrowySymbol = value;
                    OnPropertyChanged(nameof(FizCOrganRejestrowySymbol));
                }
            }
        }
        ...
        #region private string? _fizcOrganRejestrowyNazwa; public string? FizCOrganRejestrowyNazwa

        private string? _fizcOrganRejestrowyNazwa;

        /// Fiz c organ rejestrowy nazwa
        /// Fiz c organ rejestrowy nazwa
        [Column(Order = 2)]
        [XmlElement("fizC_OrganRejestrowy_Nazwa")]
        [JsonProperty(nameof(FizCOrganRejestrowyNazwa), Order = 2)]
        [Display(Name = "Fiz c organ rejestrowy nazwa", Prompt = "Wpisz Fiz c organ rejestrowy nazwa",
            Description = "Fiz c organ rejestrowy nazwa")]
        [StringLength(240)]
        [MaxLength(240)]

        public string? FizCOrganRejestrowyNazwa
        {
            get => _fizcOrganRejestrowyNazwa;
            set
            {
                if (value != _fizcOrganRejestrowyNazwa)
                {
                    _fizcOrganRejestrowyNazwa = value;
                    OnPropertyChanged(nameof(FizCOrganRejestrowyNazwa));
                }
            }
        }
        ...
        #region private string? _fizcRodzajRejestruSymbol; public string? FizCRodzajRejestruSymbol

        private string? _fizcRodzajRejestruSymbol;

        /// Fiz c rodzaj rejestru symbol
        /// Fiz c rodzaj rejestru symbol
        [Column(Order = 2)]
        [XmlElement("fizC_RodzajRejestru_Symbol")]
        [JsonProperty(nameof(FizCRodzajRejestruSymbol), Order = 2)]
        [Display(Name = "Fiz c rodzaj rejestru symbol", Prompt = "Wpisz Fiz c rodzaj rejestru symbol",
            Description = "Fiz c rodzaj rejestru symbol")]
        [StringLength(3)]
        [MaxLength(3)]

        public string? FizCRodzajRejestruSymbol
        {
            get => _fizcRodzajRejestruSymbol;
            set
            {
                if (value != _fizcRodzajRejestruSymbol)
                {
                    _fizcRodzajRejestruSymbol = value;
                    OnPropertyChanged(nameof(FizCRodzajRejestruSymbol));
                }
            }
        }
        ...
        #region private string? _fizcRodzajRejestruNazwa; public string? FizCRodzajRejestruNazwa

        private string? _fizcRodzajRejestruNazwa;

        /// Fiz c rodzaj rejestru nazwa
        /// Fiz c rodzaj rejestru nazwa
        [Column(Order = 2)]
        [XmlElement("fizC_RodzajRejestru_Nazwa")]
        [JsonProperty(nameof(FizCRodzajRejestruNazwa), Order = 2)]
        [Display(Name = "Fiz c rodzaj rejestru nazwa", Prompt = "Wpisz Fiz c rodzaj rejestru nazwa",
            Description = "Fiz c rodzaj rejestru nazwa")]
        [StringLength(240)]
        [MaxLength(240)]

        public string? FizCRodzajRejestruNazwa
        {
            get => _fizcRodzajRejestruNazwa;
            set
            {
                if (value != _fizcRodzajRejestruNazwa)
                {
                    _fizcRodzajRejestruNazwa = value;
                    OnPropertyChanged(nameof(FizCRodzajRejestruNazwa));
                }
            }
        }
        ...
        #region private bool? _fizcNiePodjetoDzialalnosci; public bool? FizCNiePodjetoDzialalnosci

        private bool? _fizcNiePodjetoDzialalnosci;

        /// Fiz c nie podjeto dzialalnosci
        /// Fiz c nie podjeto dzialalnosci
        [Column(Order = 2)]
        [XmlElement("fizC_NiePodjetoDzialalnosci")]
        [JsonProperty(nameof(FizCNiePodjetoDzialalnosci), Order = 2)]
        [Display(Name = "Fiz c nie podjeto dzialalnosci", Prompt = "Wpisz Fiz c nie podjeto dzialalnosci",
            Description = "Fiz c nie podjeto dzialalnosci")]


        public bool? FizCNiePodjetoDzialalnosci
        {
            get => _fizcNiePodjetoDzialalnosci;
            set
            {
                if (value != _fizcNiePodjetoDzialalnosci)
                {
                    _fizcNiePodjetoDzialalnosci = value;
                    OnPropertyChanged(nameof(FizCNiePodjetoDzialalnosci));
                }
            }
        }
