...
xsd .\BIR11OsFizycznaDaneOgolne.xsd /classes /language:CS /namespace:PortalApiGusApiRegonData.Models.DanePobierzPelnyRaport /type:OsFizycznaDaneOgolne /nologo /outputdir:C:\Praca\NetCoreDev\PortalApiGus\ApiRegon\PortalApiGusApiRegonData\Models\DanePobierzPelnyRaport
