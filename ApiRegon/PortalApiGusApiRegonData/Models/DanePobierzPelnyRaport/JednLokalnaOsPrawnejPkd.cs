...
namespace PortalApiGusApiRegonData.Models.DanePobierzPelnyRaport
{
    ...
    [Serializable]
    [XmlRoot("dane")]
    public class JednLokalnaOsPrawnejPkd
    {
        ...
        [Display(Name = "Kod PKD lokalnej osoby prawnej", Prompt = "Wpisz kod PKD lokalnej osoby prawnej",
            Description = "Kod PKD lokalnej osoby prawnej")]
        ...
        [Display(Name = "Nazwa PKD lokalnej osoby prawnej", Prompt = "Wpisz nazwę PKD lokalnej osoby prawnej",
            Description = "Nazwa PKD lokalnej osoby prawnej")]
        ...
        [Display(Name = "Przeważające PKD lokalnej osoby prawnej",
            Prompt = "Wpisz przeważające PKD lokalnej osoby prawnej",
            Description = "Przeważające PKD lokalnej osoby prawnej")]
