...
namespace PortalApiGusApiRegonData.Models.DanePobierzPelnyRaport
{
    ...
    [Serializable]
    [XmlRoot("dane")]
    public class JednLokalnaOsFizycznejPkd
    {
        ...
        [Display(Name = "Kod PKD jednostki lokalnej osoby fizycznej",
            Prompt = "Wpisz kod PKD jednostki lokalnej osoby fizycznej",
            Description = "Kod PKD jednostki lokalnej osoby fizycznej")]
        ...
        [Display(Name = "Nazwa PKD jednostki lokalnej osoby fizycznej",
            Prompt = "Wpisz nazwę PKD jednostki lokalnej osoby fizycznej",
            Description = "Nazwa PKD jednostki lokalnej osoby fizycznej")]
        ...
        [Display(Name = "PKD przeważające jednostki lokalnej osoby fizycznej",
            Prompt = "Wpisz PKD przeważające jednostki lokalnej osoby fizycznej",
            Description = "PKD przeważające jednostki lokalnej osoby fizycznej")]
        ...
        [Display(Name = "Symbol PKD jednostki lokalnej osoby fizycznej",
            Prompt = "Wpisz symbol PKD jednostki lokalnej osoby fizycznej",
            Description = "Symbol PKD jednostki lokalnej osoby fizycznej")]
